...
.versus { display: grid; grid-template-columns: minmax(0, 1fr) auto minmax(0, 1fr); align-items: start; gap: 8px; font-weight: 800; }
.versus > b { align-self: center; padding-top: 31px; }
.versus > .cardTeam { text-align: center; }
.cardTeam { display: grid; grid-template-rows: 48px minmax(22px, auto); align-items: center; justify-items: center; gap: 4px; min-width: 0; text-align: center; }
.cardLogo { width: 56px; height: 48px; display: grid; place-items: center; }
.cardLogo img { max-width: 46px; max-height: 42px; width: auto; height: auto; object-fit: contain; }
.cardTeamName { color: var(--text); overflow-wrap: anywhere; line-height: 1.15; min-height: 22px; display: grid; place-items: center; }
...
@media (max-width: 720px) {
  ...
  .versus { gap: 5px; }
  .cardTeam { gap: 3px; }
  .cardLogo { width: 42px; height: 38px; }
  .cardLogo img { max-width: 36px; max-height: 34px; }
  .versus > b { padding-top: 25px; }
