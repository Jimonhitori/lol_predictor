...
.championMetaRow { grid-template-columns: minmax(160px, 1fr) 50px 50px 54px 54px 54px; gap: 6px; align-items: center; }
...
@media (max-width: 720px) {
  ...
  .championMetaRow { grid-template-columns: minmax(118px, 1fr) 46px 52px 50px 50px; gap: 5px; }
  .championMetaRow > span:nth-child(3) { display: none; }
...
@media (max-width: 520px) {
  ...
  .championMetaRow { grid-template-columns: minmax(104px, 1fr) 40px 46px 44px 44px; }
