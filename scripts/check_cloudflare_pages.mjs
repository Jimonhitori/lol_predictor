...
function summarizeDiagnostics(result) {
  return {
    ...
    configured_prediction_feed_url: result.json?.configured_prediction_feed_url || '',
    ...
    remote_prediction_feed_checked: result.json?.remote_prediction_feed_checked ?? null,
    remote_prediction_feed_url: result.json?.remote_prediction_feed_url || '',
    remote_prediction_feed_available: result.json?.remote_prediction_feed_available ?? null,
    remote_prediction_feed_last_fetch_status: result.json?.remote_prediction_feed_last_fetch_status ?? null,
    remote_prediction_feed_schema: result.json?.remote_prediction_feed_schema || '',
    remote_prediction_feed_rows: result.json?.remote_prediction_feed_rows ?? null,
    remote_prediction_feed_freshness: result.json?.remote_prediction_feed_freshness || '',
